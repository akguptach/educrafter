...
class Orders extends Model
{
    ...
    protected $fillable = ['coupon_code_id','gross_price','fileupload', 
    'title', 'task', 'delivery_date', 'website_id', 'subject_id', 'task_type_id', 
    'studylabel_id', 'grade_id', 'referencing_style_id', 'no_of_words', 'price', 
    'student_id', 'payment_status', 'task_status', 'writer_id', 'qc_id', 'rating', 
    'review', 'currency_code','wallet_paid','attachment_url'];
