    ...
    <div class="container">
        <div class="row">
                ...
                <ul class="nav nav-pills nav-pills-new nav-fill mb-3" id="mainTab" role="tablist">
                    ...
                    <!--<li class="nav-item" role="presentation">
						       <button class="nav-link active" id="new-order-tab" data-bs-toggle="tab" data-bs-target="#new-order-tab-pane"
                                type="button" role="tab" aria-controls="new-order-tab-pane" aria-selected="false">Orders</button>
                            
                        </li>-->

                    <!--<li class="nav-item" role="presentation">
                        <button class="nav-link" id="exiting-order-tab" data-bs-toggle="tab"
                            data-bs-target="#exiting-order-tab-pane" type="button" role="tab"
                            aria-controls="exiting-order-tab-pane" aria-selected="false">Orders</button>
                    </li>-->
                </ul>
                <div class="tab-content" id="mainTabContent">
                    <?php /* <div class="tab-pane fade show active" id="new-order-tab-pane" role="tabpanel"
                        aria-labelledby="new-order-tab" tabindex="0">
            ...
            <div class="tab-content" id="newOrderTabContent">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$arrR['currency_code']}} {{$arrR['price']}} /
                                        {{$arrR['price']}}</td>
                ...
                <div class="tab-pane fade" id="enquiries-tab-pane" role="tabpanel" aria-labelledby="enquiries-tab"
                    tabindex="0">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <thead>
