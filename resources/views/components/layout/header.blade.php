...
$q->whereIn('seo_url_slug',['dissertation-writing-service','term-paper-writing-service','report-writing-service','essay-writing-help','research-paper-writing-service','assignment-writing-service']);
})->get();
?>
<!DOCTYPE html>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                ...
                <a class="navbar-brand mx-auto mx-md-start" href="{{ route('home') }}">
                    <picture>
                        <svg width="159" height="23" viewBox="0 0 159 23" fill="none"
                            ...
                            <g clip-path="url(#clip0_2371_12428)">
                                ...
                                <rect y="0.275192" width="10.2882" height="21.1485" rx="5.14408"
                                    ...
                                    fill="#3B71ED" stroke="black" stroke-width="0.403422" />
                                <rect y="0.275192" width="10.2882" height="21.1485" rx="5.14408"
                                    transform="matrix(0.731217 0.682145 -0.731217 0.682145 21.5372 -4.65935)"
                                    fill="#EE674E" stroke="black" stroke-width="0.403422" />
                                <rect y="0.275192" width="10.2882" height="21.1485" rx="5.14408"
                                    transform="matrix(0.731217 0.682145 -0.731217 0.682145 28.6387 2.58234)"
                                    fill="#A888CE" stroke="black" stroke-width="0.403422" />
                            </g>
                            <path
                                ...
                                stroke="black" stroke-width="0.403422" />
                            <path
                ...
                <div class="collapse navbar-collapse" id="withlogin">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ (request()->is('refer_friend') ) ? 'active' : '' }}"
                                href="{{ route('refer_friend') }}">Refer a friend</a>
                        </li>

                        <li class="nav-item">
                            <div class="dropdown">
                                <a class="nav-link {{ (request()->is('Services') ) ? 'active' : '' }}"
                                    href="{{ route('Services') }}">Our Services <i class="fa fa-angle-down"></i></a>
