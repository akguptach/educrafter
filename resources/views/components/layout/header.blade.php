<?php
$services = \App\Models\Service::where('website_type', 'Educrafter')->where('type', 'SERVICE')->get();
?>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="withlogin">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link {{ (request()->is('why_us') ) ? 'active' : '' }}" aria-current="page"
                                href="{{ route('why_us') }}">Why us?</a>
                        </li>
                        <li class="nav-item">
