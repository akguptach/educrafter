...
$q->whereIn('seo_url_slug',['book-report-help']);
})->get();
                        ...
                        <li class="nav-item">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    <a class="dropdown-item" href="#">Dissertation Writing Service</a>
                                    <a class="dropdown-item" href="#">Essay Writing Service
                                    </a>
                                    <a class="dropdown-item" href="#">Report Writing Service
                                    </a>
                                    <a class="dropdown-item" href="#">Assignment Writing Service
                                    </a>
                                    <a class="dropdown-item" href="#">Term Paper Writing Service
                                    </a>
                                    <a class="dropdown-item" href="#">Research Paper Writing Service
                                    </a>
                                </div>
                            </div>
                        </li>
