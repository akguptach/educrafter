...
<link href="https://fonts.googleapis.com/css2?family=Antonio:wght@100..700&display=swap" rel="stylesheet">
  ...
  <body>
	...
	<div class="navmenu">
		<div class="menu_wrap">
			<div class="menu">
				<a href="#" class="btn arrow-btn">Hire Tutor <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg" data-inject-url="https://html.themegenix.com/skillgro/assets/img/icons/right_arrow.svg" class="injectable">
					   ...
					   <li class="menu-item-has-children"><a href="#">Services</a>
							<ul class="sub-menu">
							    @foreach($services as $service)
                                    ...
                                    <li><a href="{{ route('Services.Index',['slug'=>@$service->seo->seo_url_slug]) }}">{{$service->service_name}}</a></li>
                                    @endif
                                    @endforeach
