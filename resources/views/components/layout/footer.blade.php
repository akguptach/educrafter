                ...
                <div class="col-xl-4 col-lg-4 mb-50">
                    <div class="footer-widget">
                        <div class="footer-logo">
                            <a href="#"><svg width="159" height="23" viewBox="0 0 159 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="footer-text">
                            <p>EduCrafter, achieving the grades you've always wanted has never been easier. Our top-notch essay writers are ready to assist you.</p>
                        </div>
                        <div class="footer-social-icon">
                            <span>Follow us</span>
                            <a href="https://www.instagram.com/educrafter.co" target="_blank"><img src="{{ asset('images/instagram.svg')}}" width="40" alt="Image 2"></a>
                            <a href="https://www.linkedin.com/company/edu-crafter/" target="_blank"><img src="{{ asset('images/linkedin-logo.svg')}}" width="40" alt="Image 2"></a>
                            <a href="#"><img src="{{ asset('images/tiktok.svg')}}" style="background: #fff;border-radius: 7px;padding: 5px;" width="40" alt="Image 2"></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="footer-widget">
                        ...
                        <div class="subscribe-form">
                            <div class="single-cta">
                                <span style="float: left;width: 14%;"><img src="{{ asset('images/gurantee.webp')}}" width="50" alt="Guarantee Image"></span>
                                <span style="float: left;width: 86%;font-size:14px;color:#fff;padding-top: 5px;">The money-back guarantee operates according to our Refund Policy.</span>
                            </div>

                        </div>
                        <div class="subscribe-form">
                            <div class="single-cta">
                                <span style="float: left;margin-top:20px;"><a href="//www.dmca.com/Protection/Status.aspx?ID=4f98b10a-59c8-4975-8c66-955c1eeb7b48" title="DMCA.com Protection Status" class="dmca-badge"> <img src="https://images.dmca.com/Badges/dmca_protected_sml_120l.png?ID=4f98b10a-59c8-4975-8c66-955c1eeb7b48" alt="DMCA.com Protection Status" /></a>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-6 mb-30">
                    <div class="footer-widget">
                        ...
                        <ul>
                            <li><a href="https://educrafter.co/terms-and-conditions">Terms and conditions</a></li>
                            <li><a href="https://educrafter.co/privacy-policy">Policy Privacy</a></li>
                            <li><a href="https://educrafter.co/refund-policy">Refund policy</a></li>
                            <li><a href="https://educrafter.co/cookies-policy">Cookies policy</a></li>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 mb-30">
                    <div class="footer-widget">
                        ...
                        <ul>
                            <li><a href="https://educrafter.co">Home</a></li>
                            <li><a href="{{ route('about-us')}}">About Us</a></li>
                            <li><a href="https://educrafter.co/contact-us">Contact Us</a></li>
                            <li><a href="https://educrafter.co/faq">Faq's</a></li>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 text-center">
                    <div class="copyright-text">
                        <p>Copyright &copy; 2024, All Right Reserved <a href="https://educrafter.co/">EduCrafter</a></p>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        $('#subscription_email').on('keyup', function() {
            var email = $(this).val();
            var emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
            if (!emailRegex.test(email)) {
                $('#alert_message').text("Please enter a valid email address.");
            } else {
                $('#alert_message').text(""); // Clear the alert message if email is valid
            }
        });
        ...
        $("#subscribe_button").click(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('#alert_message').text(response.message).css('color', 'green');
                    $("#subscription_email").val("");
                },
                error: function(xhr, status, error) {
                    $('#alert_message').text(xhr.responseJSON.error).css('color', 'red');
                }
            });
        });
    });
