                ...
                <div class="signup-form">
                    ...
                    <div class="form-main mt-4">
                        ...
                        <div class="form-wrapper">
                            <div id="invalid_login_data" class="error" style="display:none">Invalid email / phone number
                                or password</div>
                            <div id="success_register" class="success" style="display:none">Registered successfully, now
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group flex-nowrap">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                aria-describedby="email-wrapping" name="email"
                                                onkeyup="error_form('invalid_login_data','success_register')">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="input-group flex-nowrap">
