                        ...
                        <div class="signup-form">
                            ...
                            <div class="form-main mt-4">
                                ...
                                <div class="form-wrapper">
                                    <div id="invalid_signup_data" class="error" style="display:none">Email or phone
                                        number already exists</div>
                                    <form action="{{route('signup')}}" class="form-common" id="signup_form"
                                        method="POST">
                                        @csrf
                                        <div class="row gy-3 gx-2">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control"
                                                    placeholder="Enter your last name" aria-label="Enter your last name"
                                                    name="last_name">
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control"
                                                    style="width: 22%;float: left;margin-right: 5px;"
                                                    name="country_code">
                                                    @if(!empty($countries))
                                                    @foreach ($countries as $country1)
                                                    <option value="{{$country1->dial}}" @if($country1->iso3 ==
                                                        $countryCode) selected @endif> {{$country1->dial}}</option>
                                                    @endforeach
                                                    @endif
                                                    </slect>
                                                    <input type="tel" class="form-control"
                                                        placeholder="Enter your phone number"
                                                        aria-label="Enter your phone number" name="phone_number"
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group flex-nowrap">
                                                    ...
                                                    <input type="password" class="form-control"
                                                        ...
                                                        aria-describedby="repassword-wrapping" name="confirm_password">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                    ...
                                    <p class="text-center mt-4 mb-0">Already have an account? <a data-bs-toggle="modal"
                                            href="#loginModal" class="link">Login</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
