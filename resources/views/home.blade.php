        ...
        <div class="container">
		  ...
		  <div class="col-lg-12">
              <div class="banner__images-three">
                ...
                <div class="about__enrolled11" data-aos="fade-right" data-aos-delay="900">
                  
                  <img src="{{ asset('img/banner1_l.png')}}" alt="img" >
                </div>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="banner__content-three" align="center">
                <h2 class="title" data-aos="fade-right" data-aos-delay="400" style="text-align: center;line-height: 134px;font-family: 'Sofia Pro'; font-weight: bold; font-style: normal;">Achieve Excellent Grades With World Class Tutors</h2>
                <p data-aos="fade-right" data-aos-delay="600" style="text-align: center;">Our tutors can assist with anything from short essays, exam notes, and research papers to proofreading and editing, or even your full dissertation.</p>
      ...
      <section class="courses-area section-pt-30 section-pb-30">
        ...
        <div class="tab-content" id="courseTabContent">
                      ...
                      <div class="rc-post-item">
                        <div class="rc-post-thumb">
                          <a href="blog-details.html">
                            <img src="{{ asset('img/tutors/female/Avatar Image-1.png')}}" alt="img" >
                          </a>
                        </div>
                        <ul class="courses__item-meta list-wrap">
                          ...
                          <li class="avg-rating">
                            <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i> 3k+
                          </li>
                        </ul>
                      </div>
				  ...
				  <div class="swiper-slide">
                    <div class="courses__item shine__animate-item">
                      <div class="rc-post-item">
                        <div class="rc-post-thumb">
                          <a href="blog-details.html">
                            <img src="{{ asset('img/tutors/male/Avatar Image-1.png')}}" alt="img">
                          </a>
                        </div>
                        <ul class="courses__item-meta list-wrap">
                          <li>
				  ...
				  <div class="swiper-slide">
                    <div class="courses__item shine__animate-item">
                      <div class="rc-post-item">
                        <div class="rc-post-thumb">
                          <a href="blog-details.html">
                            <img src="{{ asset('img/tutors/female/Avatar Image-11.png')}}" alt="img">
                          </a>
                        </div>
                        <ul class="courses__item-meta list-wrap">
                          <li>
				  ...
				  <div class="swiper-slide">
                    <div class="courses__item shine__animate-item">
                      <div class="rc-post-item">
                        <div class="rc-post-thumb">
                          <a href="blog-details.html">
                            <img src="{{ asset('img/tutors/male/Avatar Image-4.png')}}" alt="img">
                          </a>
                        </div>
                        <ul class="courses__item-meta list-wrap">
                          <li>
				  ...
				  <div class="swiper-slide">
                    <div class="courses__item shine__animate-item">
                      <div class="rc-post-item">
                        <div class="rc-post-thumb" >
                          <a href="blog-details.html">
                            <img src="{{ asset('img/tutors/female/Image.png')}}" alt="img">
                          </a>
                        </div>
                        <ul class="courses__item-meta list-wrap">
                          <li>
			  ...
			  <div style="width:100%;text-align:Right;padding-right:4%;color: #000;">
			    <span style="padding: 9px 0px 0px 6px;float: right;"><img src="{{ asset('img/arrow.png')}}" style="width:20px;" ></span>
		...
		<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12" align="center">
					<p style="margin: 20px 0px 20px 0px;color: #000;font-weight: 400;font-size: 16px;"><img src="{{ asset('img/no ai.svg')}}" style="width:20px;">&nbsp;&nbsp;No AI involvement, 100% authentic guidance from tutors</p>
				</div>
		</div>
    ...
    box-shadow: 5px 4px 0px 0px #000000;
	  ...
	  <section class="courses-area-two tg-motion-effects courses__bg" style="padding-top: 100px;margin-top:50px;">
            <div class="container">
                ...
                <div class="row justify-content-center" style="background:url('{{ asset('img/bg2.png')}}');background-size: 100% 100%;">
                    
                    <div class="col-xl-6 col-lg-6 col-md-6" style="height:500px;">
					    <div style="position: relative;top: -71px;"><img src="{{ asset('img/Paper.svg')}}" style="width:500px;"></div>
                        <div class="courses__item-four shine__animate-item" style="/* box-shadow: 14px 14px 0px 0px #14141440; *//* border: 1.02px solid #000000; */position: relative;z-index: 2;top: -649px;width: 76%;left: 27px;border-radius: 0px;border: 0px;/* transition: rotate; */transform: rotate(354deg);">
						    <p style="font-weight:bold;font-size: 2rem;color:#000;text-align:center;">Perks of EduCrafter</p>
...
">
                                    <li class="about__info-list-item">
                                        ...
                                        <span style="width:88%;"><p class="content">24/7 support by your side </p></span>
                                    </li>
                                    <li class="about__info-list-item">
                                       <span class="perks_n">2</span>
                                       <span style="width:88%;"><p class="content">Personal data safety</p></span>
                                    </li>
                                    <li class="about__info-list-item">
                                        <span class="perks_n">3</span>
                                        <span style="width:88%;"><p class="content">Unlimited Amendments</p></span>
                                    </li>
									<li class="about__info-list-item">
                                       <span class="perks_n">4</span>
                                        <span style="width:88%;"><p class="content">100% Plagiarism Free</p></span>
                                    </li>
					...
					<div class="col-xl-6 col-lg-6 col-md-6">
						...
						<div class="" style="position: relative;margin-top: 172px;left: -92px;">
							<p style="font-weight:bold;font-size:4rem;line-height: 76px;font-family:Sofia Pro, sans-serif;color: #000;width: 600px;">99% Success Story <br>Yours Begins Now</p>
							
							<p style="font-size:16px;font-family:Sofia Pro, sans-serif;    color: #000;"><span style="font-weight:bold;">Unlock Success:</span> Where Every Instruction Counts, Deadlines Are Always Met, and Papers Shine with Expert Essay Help</p>
						</div>
                    </div>
                </div>
	  ...
	  <section class="choose__area-three" style=" border-top: 3px solid #000000;border-bottom: 3px solid #000000; margin-bottom: 20px;">
            <div class="container11">
                <div class="row">
                            ...
                            <div class="choose__list-wrap">
                                <div class="choose__list-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <span>Our essay writers make sure that all orders are submitted prior to the deadline so that you can proofread your paper before handing it over to your tutor.</span>
                                    </div>
                                </div>
                                <div class="choose__list-item">
                                    <div class="icon">
                                    ...
                                    <div class="content">
                                        ...
                                        <span>All tutor profiles are meticulously checked: diplomas, identity and background. Only profiles demonstrating academic excellence are retained, ensuring you receive top quality essay help.</span>
                                    </div>
                                </div>
								<div class="choose__list-item">
                                    <div class="icon">
                                    ...
                                    <div class="content">
                                        ...
                                        <span>All Essay Help papers are scanned for duplicate content and are guaranteed to be plagiarism free, providing you with unique and original content from our expert essay writers.</span>
                                    </div>
                                </div>
                                    ...
                                    <ul class="list-wrap">
                                        <li>
                                            <div class="progress-item">
                                                <h6 class="title"><span><img src="{{ asset('img/Checkmark.png')}}"></span>Turnitin report</h6>
                                                
                                            </div>
                                        </li>
                                        <li>
                                            <div class="progress-item">
                                                <h6 class="title"><span><img src="{{ asset('img/Checkmark.png')}}"></span>Top PhD Writer </h6>
                                                
                                            </div>
                                        </li>
                                        <li>
                                            <div class="progress-item">
                                                <h6 class="title"><span><img src="{{ asset('img/Checkmark.png')}}"></span>Formatting </h6>
                                                
                                            </div>
                                        </li>
                                        <li>
                                            <div class="progress-item">
                                                <h6 class="title"><span><img src="{{ asset('img/Checkmark.png')}}"></span>Unlimited revisions</h6>
                    ...
                    <div class="col-lg-6 col-md-12" style="border-left: 3px solid #000000;padding: 0px;background-color: #c2e3fb;">
                        <div class="choose__img-three" style="background-image:url('{{ asset('img/Group 1171274562@1x.png')}}');object-fit: cover;width: 100%;background-size: contain;height: 100%;background-repeat: no-repeat;background-repeat: no-repeat;background-repeat: no-repeat;background-position: bottom;">&nbsp;</div>
                    </div>
				</div>
            </div>
        </section>
			     ...
			     <div data-w-id="7dbecf2c-55a0-2342-2a55-6b8392bc8dbe" class="testimonial-section">
                        <div class="tesimonial-inner">
                            <div class="div-block-21" style="background: #FEEAA8;border: 1px solid #000000;border-radius:76px;">
                                ...
                                <div data-w-id="70d91fa5-3c65-1f79-de04-aecda6e31732" class="div-block-22">
                                    <div
                                        data-w-id="d6405171-e1d1-4a40-fcbf-e86775599a99"
                                        style="
                                    ...
                                    ></div>
                                    <div
                                        data-w-id="d50d46ff-f48b-197f-579e-43775b27d5cf"
                                        style="
                                            -webkit-transform: translate3d(0, 0%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);
                                            -moz-transform: translate3d(0, 0%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);
                                            -ms-transform: translate3d(0, 0%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);
                                    ...
                                    ></div>
                                    <div
                                        data-w-id="69797d02-12b4-5517-c52c-174d95c27057"
                                        style="
                                            -webkit-transform: translate3d(0, 0%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);
                                            -moz-transform: translate3d(0, 0%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);
                                            -ms-transform: translate3d(0, 0%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);
                            ...
                            <div class="div-block-20">
								...
								Trusted by 250k+ Students Worldwide</p>
                        ...
                        <div class="div-block-81">
                            <div class="card-container wonder-dynamics">
                                <div class="testimonial-card wonder-dynamics" style="background: #FFF4E4;border: 0.61px solid #F0F0F0;box-shadow: 4px 5px 0px 0px #9071FB;border-radius:8px;">
                            ...
                            <div class="card-container merck">
                                <div class="testimonial-card merck" style="background: #DCF3FF;border: 0.95px solid #F0F0F0;box-shadow: 4px 5px 0px 0px #8ED993;border-radius:8px;">
								    <div class="testimonial__content-two">
										<div class="rating">
											<i class="fas fa-star"></i>
											<i class="fas fa-star"></i>
                                    ...
                                    <p class="paragraph" style="color:#000;font-size:10px;font-weight:500;">Educrafter has been a lifesaver for me. Their user-friendly service helped me ace my courses without the usual stress.</p>
                                    <div class="div-block-13-copy">
                                        
                                        <p style="font-size:16px;color:#000;font-family:'Inter'"><span style="font-weight:bold;">Sophia</span>&nbsp;&nbsp;<span style="font-size:14px;">April 20, 2024</span>&nbsp;&nbsp;<span style="font-size:14px;">Imperial College, London</span></p>
                        ...
                        <div class="card-container clutch"><img src="https://cdn.prod.website-files.com/63dae19244d432799bf5baa4/63e523b634d60a18bd161b8f_clutch.svg" loading="lazy" alt="" class="clutch" /></div>
                        <div class="card-container pencil"><img src="https://cdn.prod.website-files.com/63dae19244d432799bf5baa4/63e524b35f5d677e9845c642_pencil.svg" loading="lazy" alt="" class="pencil" /></div>
                        ...
                        <div class="card-container scott22">
                            <div id="drag" class="gif-container scott22"><img src="{{ asset('img/image 405.gif')}}" loading="lazy" alt="" class="gif" /></div>
                        </div>
                        
						<div class="card-container scott">
                            <div id="drag" class="gif-container scott"><img src="{{ asset('img/111.gif')}}" loading="lazy" alt="" class="gif" /></div>
                        </div>
...
.testimonial-card.merck {
    ...
    right: auto;
                        ...
                        <div class="card-container hand">
                            <div class="gif-container hand"><img src="{{ asset('img/hand.png')}}" loading="lazy" alt="" class="gif" /></div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="testimonial__item-wrap">
                            ...
                            <div class="swiper-container testimonial-swiper-active-two">
                                <div class="swiper-wrapper">
								     @foreach ($homepageRating as $rating)
                                    <div class="swiper-slide">
                                        ...
                                        <div class="testimonial__item-two" style="padding:30px 15px 15px 15px;">
                                            ...
                                            <div class="testimonial__author testimonial__author-two">
                                                ...
                                                <div class="testimonial__author-content testimonial__author-content-two">
													...
													<div style="width:100%;float: left;margin-bottom: 10px;"><span style="color:#475569;font-size:14px;float: left;width:100%;">{{ $newDate2 }}</span>
                                                    <span style="color: #0056D1;font-size:14px;margin-top:5px;float: left;width:100%;">{{$arrName[1]}}</span></div>
													
                                                </div>
                                            </div>
											<p style="color: #475569;font-size:14px;margin-top:10px;line-height: 22px;font-family: inter;">{!! Str::words(strip_tags($rating->description), 18, ' <a href="javascript:void(0)" onclick="toggleDescription(event, '.$rating->id.')" style="text-decoration: none; "> Read more...</a>') !!}</p>
                                        </div>
									</div>
                                    @endforeach
								</div>
		...
		<section class="brand-area" style="background:#C2E3FB;margin-bottom:50px;border: 1px solid #000000">
			<div class="container-fluid">
				   <h3 style="padding-top: 20px;padding-bottom:20px;text-align:center;">250k+ students trust us, and you can too!</h3>
				    <div class="marquee_mode" id="marquee_mode_top11">
						<div class="brand__item" style="border: 1px solid #C6C6C6;border-radius: 8px;padding: 10px;box-shadow: 3px 4px 0px 0px #000000;background: #fff;">
	     ...
	     <!-- testimonial-area -->
        <section class="testimonial__area-two section-pt-30 pb-60 testimonial__bg" style="background: #FFF4E4;border: 1px solid #000000;box-shadow: 0px 7px 0px 0px #000000;">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-5">
        ...
        <div class="container-fluid">
          <div class="marquee_mode" id="marquee_mode">
            ...
            <div class="brand__item">
              <a href="#">
                <img src="{{ asset('img/star.png')}}" style="width:20px;">&nbsp;&nbsp;&nbsp;&nbsp;Absolute Discretion
              </a>
            </div>
            <div class="brand__item">
              <a href="#">
        ...
        <div class="container" style="border: 1px solid #000000;box-shadow: 4px 4px 0px 0px #000000;border-radius:24px;">
          <div class="row">
            <div class="col-12">
              <div class="section__title text-center mt-50">
                <h1 class="title">Service we offer</h1>
				<p>From Essays to Dissertation, Our Essay Writers Can Handle It All with Skill and Precision.</p>
              </div>
            </div>
          </div>
          <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-12 col-md-12">
			        ...
			        <div class="home_services" style="height:500px;">
                        ...
                        <div class="service-block purple off"><p class="large off">Proof-Reading</p></div>
                        <div class="service-block green off"><p class="large off">Dissertation</p></div>
                        <div class="service-block red off"><p class="large off">Editing</p></div>
                        <div class="service-block sky off"><p class="large off">Thesis</p></div>
                        <div class="service-block yellow off"><p class="large off">Formatting</p></div>
						<div class="service-block gray off"><p class="large off">Assignments</p></div>
						<div class="service-block pink off"><p class="large off">Reports</p></div>
						<div class="service-block black off"><p class="large off">Essays-Writing</p></div>
						<div class="service-block white off"><p class="large off">SOP-Writing</p></div>
						<div class="service-block blue off"><p class="large off">Papers</p></div>
                    </div>
				    ...
				    <div class="row justify-content-center">
						<div class="col-xl-12">
							<div class="section__title text-center mb-40">
								...
								<h2 class="title" style="font-size:3em;">Make your studies effortless with our essay writing service</h2>
							...
							<div class="col-lg-6">
								...
								<div class="choose__content" style="border: 1px solid #000000;border-radius:24px;">
									<div class="section__title mb-15" style="height: 38px;">
										<span style="width: 13%;float: left;padding: 9px 0px 0px 0px;"><img src="{{ asset('img/writing_service/1.svg')}}" style="width: 55px;"></span>
										<span style="float: left;width: 87%;"><h4 class="subtitle" style="font-size:28px;">{{$arrR->title}}</h4></span>
									</div>
									<p style="font-size: 16px;   font-weight: 400; text-align:justify;font-family: 'Inter';">{!!$arrR->description!!}</p>
