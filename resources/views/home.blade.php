					...
					<div class="work-card" style="padding: 1rem 1rem 0;">
						<div class="card-body text-center" style="padding-top:0px;">
							...
							<ul class="nav nav-pills flex-column" id="myTab" role="tablist">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" id="other-assignments-tab" data-bs-toggle="tab" href="#other-assignments" role="tab" aria-controls="other-assignments" aria-selected="false" style="padding: 15px;border: 1px solid #0d6efd;margin-top: 10px;margin-bottom: 20px;">Other assignments</a>
								</li>
							</ul>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-6 d-flex flex-column justify-content-end">
					<div class="assign-content">
						...
						<a class="btn btn-primary" href="#" role="button" style="color: #3b71ed;background: #fff;border: 1px solid #fff;">Get started</a>
					</div>
				</div>
				<div class="col-md-6 text-center">
					<picture>
