    ...
    <div class="col-md-6">
        <div class="signup-form">
            <div class="d-flex justify-content-between px-3">
                <img src="{{ asset('images/essay-help-logo.svg') }}" alt="Essay Help" title="Essay Help" width="150"
                    height="22">
            ...
            <div class="form-main mt-4">
                ...
                <div class="form-wrapper">
                    <div id="invalid_login_data" class="error" style="display:none">Invalid email / phone number or
                        password</div>
                            ...
                            <div class="col-md-12">
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" class="form-control"
                                        ...
                                        aria-label="Enter your email / phone number" aria-describedby="email-wrapping"
                                        name="email" onkeyup="error_form('invalid_login_data','success_register')">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="password" class="form-control" placeholder="Enter your password"
                                        ...
                                        name="password" onkeyup="error_form('invalid_login_data','success_register')">
                                </div>
                            </div>
                            <div class="col-md-12">
