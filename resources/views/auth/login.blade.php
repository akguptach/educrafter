        ...
        <div class="signup-form">
            ...
            <div class="form-main mt-4">
                ...
                <div class="form-wrapper">
                    ...
                    <p class="text-center mt-4 mb-0">Don’t have an account? <a href="{{route('signup')}}"
                            class="link">Signup</a></p>
                    <p class="text-center mt-2 mb-0">Forget Password? <a href="{{route('reset.password.page')}}"
                            class="link">Forgot Password</a></p>
                </div>
            </div>
        </div>
    </div>
