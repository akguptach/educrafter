    ...
    <div class="col-md-4 loginform">
        <div class="signup-form">
            ...
            <div class="form-main mt-4">
                <div class="form-head">
                    <h2 style="font-size: 1em;">Welcome Back!</h2>
                    <p style="font-size: 12px;">Login to your account by entering the following details</p>
                </div>
                <div class="form-wrapper">
                        ...
                        <div class="row gy-3 gx-2">
                            <div class="col-md-12">
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter your email / phone number" aria-label="Enter your email / phone number" aria-describedby="email-wrapping" name="email" onkeyup="error_form('invalid_login_data','success_register')">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="password" class="form-control" placeholder="Enter your password" aria-label="Enter your password" aria-describedby="password-wrapping" name="password" onkeyup="error_form('invalid_login_data','success_register')">
                                </div>
                            </div>
                            <div class="col-md-12">
                    ...
                    <p class="text-center mt-2 mb-0">Forget Password? <a href="{{route('reset.password.page')}}" class="link">Forgot Password</a></p>
                    <p class=" text-tcnp" style="font-size: 12px;text-align: center; margin-top: 20px;">
                        By creating an account, you agree to the <a href="{{route('terms-and-conditions')}}" class="link">Terms and Conditions</a> and <a href="{{route('privacy-policy')}}" class="link">Privacy Policy</a>.
                    </p>
                </div>
            </div>
        </div>
