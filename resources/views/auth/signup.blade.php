                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="singUp-wrap">
                        <div align="center" style="margin-bottom: 25px;"><a href="{{ route('home') }}"><img
                                    src="{{ asset('img/Logo.png')}}" alt="img"
                                    style="text-align: center;width: 38%;"></a></div>
                        <h2 class="title">Sign Up</h2>
                        <p>Create your account by filling up your details</p>
                        <div id="invalid_signup_data" class="error alert alert-danger" style="display:none"></div>
                        <div id="signup_success" class="success alert alert-success" style="display:none"></div>
                        ...
                        <form action="{{route('signup')}}" class="account__form" id="signup_form" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-grp">
                                        ...
                                        <input type="text" placeholder="First name" aria-label="Enter your first name"
                                            name="first_name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-grp">
                                        ...
                                        <input type="text" placeholder="Last name" aria-label="Enter your last name"
                                            name="last_name">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-grp cuntry_code">
                                ...
                                <input type="text" placeholder="Enter your phone number"
                                    aria-label="Enter your phone number" name="phone_number" id="phone_number" required>
                            ...
                            <div class="row">
                                ...
                                <!--<div class="col-4 col-sm-4">
                                    <a href="#" class="account__social-btn"
                                        style="background:  #3B71ED;border: 1px solid #3B71ED">
                                ...
                                <div class="col-4 col-sm-4">
                                    <a href="#" class="account__social-btn"
                                        style="background: #05070F;border: 1px solid #000000;">
                        ...
                        <div class="account__switch">
                            ...
                            <p style="margin-top:20px;display:block;">By creating an account, you agree to the <a
                                    href="{{route('terms-and-conditions')}}">Terms and Conditions</a> and <a
        ...
        submitHandler: function(form) {
            ...
            $.post("{{route('signup')}}", formData)
                .done(function(response) {
                    ...
                    $('#signup_success').show();
                    $('#signup_success').html('Thanks for registration');
                    setTimeout(function() {
                ...
                .fail(function(xhr, status, error) {
                    ...
                    //alert(message)
                    $('#invalid_signup_data').html(message || message[0][0]);
