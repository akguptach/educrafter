            ...
            <div class="signup-form">
                ...
                <div class="form-main">
                    ...
                    <div class="">
                            ...
                            <div class="row gy-2 gx-1">
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="Enter your first name"
                                        aria-label="Enter your first name" name="first_name">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="Enter your last name"
                                        aria-label="Enter your last name" name="last_name">
                                </div>
                                <div class="col-md-6">
                                    <input type="email" class="form-control" placeholder="Enter your email"
                                        aria-label="Enter your email" name="email">
                                </div>
                                <div class="col-md-6 cuntry_code">
                                    ...
                                    <input type="tel" class="form-control" placeholder="Enter your phone number"
                                        aria-label="Enter your phone number" name="phone_number" id="phone_number"
                                        required>
                                ...
                                <div class="col-md-12">
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <input type="password" class="form-control" placeholder="Enter your password"
                                            aria-label="Enter your password" aria-describedby="password-wrapping"
                                ...
                                <div class="col-md-12">
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <input type="password" class="form-control" placeholder="Re-enter your password"
                                            aria-label="Re-enter your password" aria-describedby="repassword-wrapping"
                        ...
                        <div class="row gy-2 social-auth">
                        ...
                        <p class="text-center mt-4 mb-0">Already have an account? <a href="{{route('login')}}"
        ...
        <div class="col-md-6 ">
            <div class="popup-content  ">
                ...
                <img src="{{ asset('images/graduate-girl-small.png') }}" class="img-fluid" alt="Essay Help"
                    title="Essay Help" width="250" height="300">
            </div>
        </div>
    </div>
</div>
