...
<table id="u_content_text_2" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="line-height: 140%;">Hey {{ ucfirst($student) }}<br /><br />We received a request to reset your password. Please copy the OTP  below to reset your password. If you didn't request this, please ignore this email.</p>
  </div>
...
<div align="center">
    <a href="{{ env('APP_URL') }}" target="_blank" class="v-button v-size-width" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #ffc25e; border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px; width:42%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 20px;">
      <strong>{{ $code }}</strong>
    </a>
    <!--[if mso]></center></v:roundrect><![endif]-->
</div>
<p>Please do not share the verification code with anyone.</p>
  ...
  <tbody>
    <tr>
      <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:20px 40px 30px;font-family:'Raleway',sans-serif;" align="left">
		...
		<div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
		<p style="line-height: 140%;"><strong>Best,</strong></p>
