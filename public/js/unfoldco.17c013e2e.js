...
(() => {
    ...
    var c = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
        ...
        ws = (e, t, r, n) => {
            if ((t && typeof t == "object") || typeof t == "function") for (let i of X_(t)) !W_.call(e, i) && i !== r && Jr(e, i, { get: () => t[i], enumerable: !(n = k_(t, i)) || n.enumerable });
            return e;
        };
    var oe = (e, t, r) => ((r = e != null ? B_(H_(e)) : {}), ws(t || !e || !e.__esModule ? Jr(r, "default", { value: e, enumerable: !0 }) : r, e)),
    ...
    var wi = c(() => {
        ...
        window.tram = (function (e) {
                    ...
                    (l.init = function (O, X, Y, ue) {
                        ...
                        Y[2] && (M = Y[2]),
                            ...
                            he.fallback || ue.fallback
                                ...
                                : ((this.animate = this.transition), (this.string = this.name + Z + this.duration + "ms" + (this.ease != "ease" ? Z + d[this.ease][0] : "") + (this.delay ? Z + this.delay + "ms" : "")));
                    }),
                        (l.set = function (O) {
                        ...
                        (l.fallback = function (O) {
                            ...
                            (O = this.convert(O, this.type)),
                                this.auto && (X == "auto" && (X = this.convert(this.get(), this.type)), O == "auto" && (O = h.call(this))),
                                (this.tween = new z({ from: X, to: O, duration: this.duration, delay: this.delay, ease: this.ease, update: this.update, context: this }));
                        }),
                        (l.get = function () {
                ...
                te = g(q, function (l, h) {
                    ...
                    (l.init = function () {
                        h.init.apply(this, arguments),
                            this.current || ((this.current = {}), je.perspective && he.perspective && ((this.current.perspective = he.perspective), ft(this.el, this.name, this.style(this.current)), this.redraw()));
                    }),
                        (l.set = function (I) {
            ...
            var ft = e.style,
                ...
                je = {};
            D.transform && ((dr.transform = [te]), (je = { x: [x, "translateX"], y: [x, "translateY"], rotate: [G], rotateX: [G], rotateY: [G], scale: [S], scaleX: [S], scaleY: [S], skew: [G], skewX: [G], skewY: [G] })),
...
` +
    ...
    var kO,
        ...
        Tf = le(() => {
            "use strict";
            _n();
            ({ TRANSFORM_MOVE: kO, TRANSFORM_SCALE: XO, TRANSFORM_ROTATE: HO, TRANSFORM_SKEW: WO, STYLE_SIZE: jO, STYLE_FILTER: zO, STYLE_FONT_VARIATION: KO } = Le),
                (ko = { [kO]: !0, [XO]: !0, [HO]: !0, [WO]: !0, [jO]: !0, [zO]: !0, [KO]: !0 });
        });
    var Ee = {};
    Re(Ee, {
    ...
    var jf,
        ...
        Kf = le(() => {
            ...
            Ne();
            (jf = oe(Ut())),
                ({ IX2_PREVIEW_REQUESTED: bS, IX2_PLAYBACK_REQUESTED: TS, IX2_STOP_REQUESTED: IS, IX2_CLEAR_REQUESTED: OS } = Ee),
                (AS = { preview: {}, playback: {}, stop: {}, clear: {} }),
                (Wf = Object.create(null, { [bS]: { value: "preview" }, [TS]: { value: "playback" }, [IS]: { value: "stop" }, [OS]: { value: "clear" } })),
                (zf = (e = AS, t) => {
                    if (t.type in Wf) {
                        let r = [Wf[t.type]];
    ...
    var Yt,
        ...
        pv = le(() => {
            ...
            Yt = oe(Ut());
            Ne();
            ({ HTML_ELEMENT: eW, PLAIN_OBJECT: Uq, ABSTRACT_NODE: tW, CONFIG_X_VALUE: Bq, CONFIG_Y_VALUE: kq, CONFIG_Z_VALUE: Xq, CONFIG_VALUE: Hq, CONFIG_X_UNIT: Wq, CONFIG_Y_UNIT: jq, CONFIG_Z_UNIT: zq, CONFIG_UNIT: Kq } = Ie),
    ...
    var _v = {};
    Re(_v, { clearPlugin: () => Na, createPluginInstance: () => NF, getPluginConfig: () => xa, getPluginDestination: () => Ra, getPluginDuration: () => LF, getPluginOrigin: () => Ca, isPluginType: () => St, renderPlugin: () => La });
    function St(e) {
    ...
    function uM(e, t) {
        ...
        for (let i = 0; i < r.length; i++) if (!Object.hasOwn(t, r[i]) || !Bv(e[r[i]], t[r[i]])) return !1;
        return !0;
    }
    var Ma,
        kv = le(() => {
    ...
    function Ba({ config: e, event: t, eventTarget: r, elementRoot: n, elementApi: i }) {
        ...
        let { getValidDocument: s, getQuerySelector: a, queryDocument: u, getChildElements: f, getSiblingElements: p, matchSelector: g, elementContains: d, isSiblingNode: v } = i,
            { target: b } = e;
        if (!b) return [];
        let { id: m, objectId: A, selector: y, selectorGuids: w, appliesTo: S, useEventTarget: C } = Wv(b);
        ...
        let x = (t?.action?.config?.affectedElements ?? {})[m || y] || {},
            ...
            W,
            Z = t && a(Wv(t.target));
        if ((G ? ((B = x.limitAffectedElements), (k = Z), (W = a(x))) : (k = W = a({ id: m, selector: y, selectorGuids: w })), t && C)) {
            let P = r && (W || C === !0) ? [r] : u(Z);
            if (W) {
    ...
    function MM(e, t = {}, r = {}, n, i) {
        ...
        switch (n.actionTypeId) {
            ...
            case rr:
            case nr:
                return tD({ element: e, actionTypeId: n.actionTypeId, computedStyle: r, getStyle: o });
            case ri:
    ...
    function Kv({ actionGroup: e, event: t, elementApi: r }) {
        ...
        n.forEach((i) => {
            let { actionTypeId: o, config: s } = i,
                a;
            St(o) ? (a = (u) => Na(o)(u, i)) : (a = iy({ effect: aD, actionTypeId: o, elementApi: r })), Ba({ config: s, event: t, elementApi: r }).forEach(a);
        });
    }
    function oD(e, t, r) {
    ...
    var st,
        ...
        sy = le(() => {
            ...
            ({
                ...
                (ty = Object.freeze({ [Et]: lM, [$v]: cM, [Zn]: Zn, [Ur]: Ur, [tt]: tt, [rt]: rt, [Br]: Br })),
                ($n = new Map());
            SM = 1;
            xM = 1;
            LM = (e, t) => e === t;
            (jv = /px/),
                (qM = (e, t) => t.reduce((r, n) => (r[n.type] == null && (r[n.type] = XM[n.type]), r), e || {})),
                (FM = (e, t) => t.reduce((r, n) => (r[n.type] == null && (r[n.type] = HM[n.type] || n.defaultValue || 0), r), e || {}));
            ...
            (ka = {
                ...
                (XM = Object.freeze({ blur: 0, "hue-rotate": 0, invert: 0, grayscale: 0, saturate: 100, sepia: 0, contrast: 100, brightness: 100 })),
    ...
    var ii,
        ...
        ly = le(() => {
            ...
            (ii = oe(Ct())),
                (ut = oe(Ut())),
                ({ IX2_RAW_DATA_IMPORTED: _D, IX2_SESSION_STOPPED: bD, IX2_INSTANCE_ADDED: TD, IX2_INSTANCE_STARTED: ID, IX2_INSTANCE_REMOVED: OD, IX2_ANIMATION_FRAME_CHANGED: AD } = Ee),
                ({ optimizeFloat: ni, applyEasing: uy, createBezierEasing: SD } = ii.IX2EasingUtils),
                ({ RENDER_GENERAL: wD } = Ie),
                ({ getItemConfigByKey: Xa, getRenderType: xD, getStyleProp: CD } = ii.IX2VanillaUtils),
                (RD = (e, t) => {
    ...
    var ND,
        ...
        dy = le(() => {
            "use strict";
            Ne();
            ({ IX2_RAW_DATA_IMPORTED: ND, IX2_SESSION_STOPPED: PD, IX2_PARAMETER_CHANGED: qD } = Ee),
                (fy = (e = {}, t) => {
                    switch (t.type) {
                        case ND:
    ...
    var py,
        ...
        vy = le(() => {
            ...
            ly();
            dy();
            ({ ixElements: FD } = gy.IX2ElementsReducer), (MD = (0, py.combineReducers)({ ixData: Sf, ixRequest: zf, ixSession: $f, ixElements: FD, ixInstances: cy, ixParameters: fy }));
        });
    var Ey = c((MW, yy) => {
        var DD = ht(),
            GD = me(),
    ...
    var OE = c((uj, IE) => {
        ...
        function J2(e, t, r) {
            ...
            return Q2(r) && ((n = "leading" in r ? !!r.leading : n), (i = "trailing" in r ? !!r.trailing : i)), $2(e, t, { leading: n, maxWait: t, trailing: i });
        }
        IE.exports = J2;
    });
    var SE = {};
    ...
    var AE,
        ...
        ui = le(() => {
            ...
            (AE = oe(Ct())),
                ...
                ($a = ({ hasBoundaryNodes: e, reducedMotion: t }) => ({ type: tG, payload: { hasBoundaryNodes: e, reducedMotion: t } })),
                (Qa = () => ({ type: rG })),
                (Za = () => ({ type: nG })),
                (bG = ({ rawData: e, defer: t }) => ({ type: iG, payload: { defer: t, rawData: e } })),
                (TG = ({ actionTypeId: e = Le.GENERAL_START_ACTION, actionListId: t, actionItemId: r, eventId: n, allowEvents: i, immediate: o, testManual: s, verbose: a, rawData: u }) => ({
                    type: oG,
                ...
                (OG = () => ({ type: sG })),
                (oi = (e, t) => ({ type: uG, payload: { target: e, listenerParams: t } })),
                ...
                (rs = (e, t, r, n) => ({ type: vG, payload: { elementId: e, actionTypeId: t, current: r, actionItem: n } })),
                (ar = ({ actionListId: e, isPlaying: t }) => ({ type: yG, payload: { actionListId: e, isPlaying: t } })),
                (ns = ({ width: e, mediaQueries: t }) => ({ type: EG, payload: { width: e, mediaQueries: t } })),
                (is = () => ({ type: mG }));
        });
    var xe = {};
    Re(xe, {
    ...
    var xE,
        ...
        RE = le(() => {
            ...
            xE = oe(Ct());
            Ne();
            ({ ELEMENT_MATCHES: os } = xE.IX2BrowserSupport), ({ IX2_ID_DELIMITER: wE, HTML_ELEMENT: SG, PLAIN_OBJECT: wG, WF_PAGE: CE } = Ie);
    ...
    var JE = c((_j, ZE) => {
        var JG = $E(),
            ...
            tV = QE
                ? function (e, t) {
                      return QE(e, "toString", { configurable: !0, enumerable: !1, value: JG(t), writable: !0 });
                  }
                : eV;
        ZE.exports = tV;
    });
    ...
    var Wm,
        ...
        o_ = le(() => {
            ...
            (Km = oe(Ct())),
                ...
                (AU = (e, t) => !(e.left > t.right || e.right < t.left || e.top > t.bottom || e.bottom < t.top)),
                ...
                (wU = (e) => {
                    ...
                    return AU(t.getBoundingClientRect(), { left: 0, top: u, right: n, bottom: i - u });
                }),
                (n_ = (e) => (t, r) => {
                ...
                (Bm = (e) => (t, r = {}) => {
                    ...
                    let y = a === Ym ? d >= A + v : d <= A - v,
                        w = { ...r, percentTop: d, inBounds: y, anchorTop: A, scrollingDown: b };
                    return (r && y && (m || w.inBounds !== r.inBounds) && e(t, w)) || w;
                }),
                (CU = (e, t) => e.left > t.left && e.left < t.right && e.top > t.top && e.top < t.bottom),
                (RU = (e) => (t, r) => {
                ...
                (i_ = {
                    ...
                    [hU]: {
                        ...
                        handler: ({ store: e, element: t, eventConfig: r, nativeEvent: n, eventStateKey: i }, o = { clientX: 0, clientY: 0, pageX: 0, pageY: 0 }) => {
                            ...
                            return (
                                ...
                                (s !== Je.ELEMENT || S || S !== o.elementHovered) && ((y = f ? 1 - y : y), e.dispatch(or(w, y))),
                                { elementHovered: S, clientX: g, clientY: d, pageX: v, pageY: b }
                            );
                        },
                    },
                    [bU]: {
                    ...
                    [EU]: {
                        ...
                        handler: ({ element: e, store: t, eventConfig: r, eventStateKey: n }, i = { scrollPercent: 0 }) => {
                            let { scrollLeft: o, scrollTop: s, scrollWidth: a, scrollHeight: u, clientHeight: f } = zr(),
                                { basedOn: p, selectedAxis: g, continuousParameterGroupId: d, startsEntering: v, startsExiting: b, addEndOffset: m, addStartOffset: A, addOffsetValue: y = 0, endOffsetValue: w = 0 } = r,
                                S = g === "X_AXIS";
                            if (p === Je.VIEWPORT) {
                                let C = S ? o / a : s / u;
                    ...
                    [Qm]: { types: "readystatechange IX2_PAGE_UPDATE", handler: We(Kr, RU(qe)) },
                    [Zm]: { types: "readystatechange IX2_PAGE_UPDATE", handler: We(Kr, LU(qe)) },
                });
        });
    var T_ = {};
    Re(T_, { observeRequests: () => QU, startActionGroup: () => $r, startEngine: () => Ti, stopActionGroup: () => sr, stopAllActionGroups: () => m_, stopEngine: () => Ii });
    function QU(e) {
    ...
    function Ti({ store: e, rawData: t, allowEvents: r, testManual: n }) {
        ...
        t && e.dispatch(Ya(t)),
            i.active ||
                ...
                r && (cB(e), iB(), e.getState().ixSession.hasDefinedMediaQueries && ZU(e)),
                e.dispatch(Qa()),
                oB(e, n));
    }
    function iB() {
    ...
    function sB({ store: e, eventStateKey: t, eventTarget: r, eventId: n, eventConfig: i, actionListId: o, parameterGroup: s, smoothing: a, restingValue: u }) {
        ...
        y.forEach((C) => {
            ...
            A.forEach(({ element: C, key: R }) => {
                ...
                Ts({ store: e, element: C, eventId: n, actionListId: o, actionItem: G, destination: W, continuous: !0, parameterId: w, actionGroups: x, smoothing: a, restingValue: u, pluginInstance: k });
            });
    }
    function uB(e = [], t, r) {
        let n = [...e],
                ...
                b.actionTypeId === Le.GENERAL_CONTINUOUS_ACTION &&
                    (Array.isArray(v.config) ? v.config : [v.config]).forEach((S) => {
                        ...
                        x &&
                            g.forEach((k, W) => {
                                let Z = m + ms + W;
                                sB({ store: t, eventStateKey: Z, eventTarget: k, eventId: m, eventConfig: S, actionListId: y, parameterGroup: x, smoothing: G, restingValue: B });
                            });
                    }),
        ...
        if (u && u.useFirstGroupAsInitialState) {
            ...
            f.forEach((g) => {
                ...
                m.forEach((y) => {
                    ...
                    Ts({ destination: _s({ element: y, actionItem: g, elementApi: xe }, w), immediate: !0, store: e, element: y, eventId: r, actionItem: g, actionListId: t, pluginInstance: w });
                });
            });
        }
    }
    ...
    function Ts(e) {
        ...
        if ((t.dispatch(es({ instanceId: d, elementId: A, origin: R, refType: w, skipMotion: S, skipToValue: C, ...n })), __(document.body, "ix2-animation-started", d), s)) {
            yB(t, d);
            return;
        }
    ...
    var u_,
        ...
        ys = le(() => {
            ...
            (NU = Object.keys(mn)),
                (Es = (e) => NU.includes(e)),
                ({ COLON_DELIMITER: ms, BOUNDARY_SELECTOR: Ei, HTML_ELEMENT: g_, RENDER_GENERAL: PU, W_MOD_IX: a_ } = Ie),
                ({
                ...
                ({ isPluginType: bi, createPluginInstance: bs, getPluginDuration: KU } = yi.IX2VanillaPlugins),
                        ...
                        if (L !== "") {
                            ...
                            U.length &&
                                ...
                                window.setTimeout(
                                    function () {
                                        x(U, function () {
                                            S(U, "add"), U.get(0).focus({ preventScroll: !0 }), S(U, "remove");
                                        });
                                    },
                                    P ? 0 : 300
                                ));
                    ...
                    function d(A) {
                        if (s) {
                            ...
                            var y = A.touches,
                                ...
                                S = w - p;
                            (p = w), Math.abs(S) > u && r && String(r()) === "" && (i("swipe", A, { direction: S > 0 ? "right" : "left" }), b());
                        }
                    }
                    function v(A) {
                ...
                function D(N, V) {
                    ...
                    function l(E) {
                        var O = E.responseJSON && E.responseJSON.msg,
                            X = Si;
                        typeof O == "string" && O.indexOf("InvalidFileTypeError") === 0 ? (X = je) : typeof O == "string" && O.indexOf("MaxFileSizeError") === 0 && (X = dr),
                            he.text(X),
...
Webflow.require("ix2").init({
    events: {
        e: {
            ...
            mediaQueries: ["main"],
            target: { selector: ".button-primary", originalId: "63dae69273397d4c9f22626f|b1d41114-1b66-0e03-c504-a630001ffb33", appliesTo: "CLASS" },
            targets: [{ selector: ".button-primary", originalId: "63dae69273397d4c9f22626f|b1d41114-1b66-0e03-c504-a630001ffb33", appliesTo: "CLASS" }],
        ...
        "e-7": {
            ...
            target: { id: "5d7f9305-1482-e663-3e87-f83c9038636c", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "5d7f9305-1482-e663-3e87-f83c9038636c", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-8": {
            ...
            animationType: "preset",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-8", affectedElements: {}, playInReverse: false, autoStopEventId: "e-71" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "5d7f9305-1482-e663-3e87-f83c9038636c", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "5d7f9305-1482-e663-3e87-f83c9038636c", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-13": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-11", affectedElements: {}, playInReverse: false, autoStopEventId: "e-14" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "471fe825-a5db-be72-8c72-ed8344ba4a72", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "471fe825-a5db-be72-8c72-ed8344ba4a72", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-16": {
            ...
            mediaQueries: ["main"],
            target: { id: "63df5d0b8b609634b1371f37|73754695-cf5e-f9e9-af08-d7b460af89d8", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63df5d0b8b609634b1371f37|73754695-cf5e-f9e9-af08-d7b460af89d8", appliesTo: "ELEMENT", styleBlockIds: [] }],
        ...
        "e-19": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae19244d4326cd3f5baa5|70d91fa5-3c65-1f79-de04-aecda6e31732", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae19244d4326cd3f5baa5|70d91fa5-3c65-1f79-de04-aecda6e31732", appliesTo: "ELEMENT", styleBlockIds: [] }],
        ...
        "e-22": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae19244d4326cd3f5baa5|0f300277-070a-b516-8846-4fba1095fe4e", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae19244d4326cd3f5baa5|0f300277-070a-b516-8846-4fba1095fe4e", appliesTo: "ELEMENT", styleBlockIds: [] }],
        ...
        "e-23": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-19", affectedElements: {}, playInReverse: false, autoStopEventId: "e-24" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae19244d4326cd3f5baa5|0de71448-2f69-9395-3a7b-c5305a070ce6", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae19244d4326cd3f5baa5|0de71448-2f69-9395-3a7b-c5305a070ce6", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-24": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-20", affectedElements: {}, playInReverse: false, autoStopEventId: "e-23" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae19244d4326cd3f5baa5|0de71448-2f69-9395-3a7b-c5305a070ce6", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae19244d4326cd3f5baa5|0de71448-2f69-9395-3a7b-c5305a070ce6", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-27": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_CLICK",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-23", affectedElements: {}, playInReverse: false, autoStopEventId: "e-28" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae19244d4326cd3f5baa5|4fd00fb7-e1ef-2976-df50-fe07471bb794", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae19244d4326cd3f5baa5|4fd00fb7-e1ef-2976-df50-fe07471bb794", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-31": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-26", affectedElements: {}, playInReverse: false, autoStopEventId: "e-32" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae19244d4326cd3f5baa5|4fd00fb7-e1ef-2976-df50-fe07471bb794", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae19244d4326cd3f5baa5|4fd00fb7-e1ef-2976-df50-fe07471bb794", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-32": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-27", affectedElements: {}, playInReverse: false, autoStopEventId: "e-31" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae19244d4326cd3f5baa5|4fd00fb7-e1ef-2976-df50-fe07471bb794", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae19244d4326cd3f5baa5|4fd00fb7-e1ef-2976-df50-fe07471bb794", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-33": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-30", affectedElements: {}, playInReverse: false, autoStopEventId: "e-34" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "c21ed082-0c38-409c-0c28-96439166e6f6", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "c21ed082-0c38-409c-0c28-96439166e6f6", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-34": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-31", affectedElements: {}, playInReverse: false, autoStopEventId: "e-33" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "c21ed082-0c38-409c-0c28-96439166e6f6", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "c21ed082-0c38-409c-0c28-96439166e6f6", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-35": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-34", affectedElements: {}, playInReverse: false, autoStopEventId: "e-36" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "2744a9d0-5ca6-e329-6d5e-2d1778778de5", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "2744a9d0-5ca6-e329-6d5e-2d1778778de5", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-36": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-35", affectedElements: {}, playInReverse: false, autoStopEventId: "e-35" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "2744a9d0-5ca6-e329-6d5e-2d1778778de5", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "2744a9d0-5ca6-e329-6d5e-2d1778778de5", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-37": {
            ...
            target: { id: "63dae19244d4326cd3f5baa5|7dbecf2c-55a0-2342-2a55-6b8392bc8dbe", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae19244d4326cd3f5baa5|7dbecf2c-55a0-2342-2a55-6b8392bc8dbe", appliesTo: "ELEMENT", styleBlockIds: [] }],
        ...
        "e-38": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae19244d4326cd3f5baa5|1d554892-f3ab-d1dc-bc0c-eec205724d7f", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae19244d4326cd3f5baa5|1d554892-f3ab-d1dc-bc0c-eec205724d7f", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: [{ continuousParameterGroupId: "a-38-p", smoothing: 93, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
        ...
        "e-65": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".radio-pill", originalId: "63dd7d5878a04717bd29ff9a|c0811938-30f5-f384-576b-964e29a869d4", appliesTo: "CLASS" },
            targets: [{ selector: ".radio-pill", originalId: "63dd7d5878a04717bd29ff9a|c0811938-30f5-f384-576b-964e29a869d4", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-67": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_CLICK",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-42", affectedElements: {}, playInReverse: false, autoStopEventId: "e-68" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".radio-pill", originalId: "63dd7d5878a04717bd29ff9a|c0811938-30f5-f384-576b-964e29a869d4", appliesTo: "CLASS" },
            targets: [{ selector: ".radio-pill", originalId: "63dd7d5878a04717bd29ff9a|c0811938-30f5-f384-576b-964e29a869d4", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-69": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_CLICK",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-43", affectedElements: {}, playInReverse: false, autoStopEventId: "e-70" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".radio", originalId: "63dae69273397d4c9f22626f|9eb952be-ec0f-5e65-9fbf-404962173ae6", appliesTo: "CLASS" },
            targets: [{ selector: ".radio", originalId: "63dae69273397d4c9f22626f|9eb952be-ec0f-5e65-9fbf-404962173ae6", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-71": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_CLICK",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-44", affectedElements: {}, playInReverse: false, autoStopEventId: "e-72" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".radio", originalId: "63dae69273397d4c9f22626f|9eb952be-ec0f-5e65-9fbf-404962173ae6", appliesTo: "CLASS" },
            targets: [{ selector: ".radio", originalId: "63dae69273397d4c9f22626f|9eb952be-ec0f-5e65-9fbf-404962173ae6", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-73": {
            ...
            animationType: "preset",
            eventTypeId: "MOUSE_CLICK",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-39", affectedElements: {}, playInReverse: false, autoStopEventId: "e-74" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae69273397d4c9f22626f|bd3f953d-891e-bb4e-0fdd-a81adf4a83eb", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae69273397d4c9f22626f|bd3f953d-891e-bb4e-0fdd-a81adf4a83eb", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-74": {
            ...
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-40", affectedElements: {}, playInReverse: false, autoStopEventId: "e-73" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae69273397d4c9f22626f|bd3f953d-891e-bb4e-0fdd-a81adf4a83eb", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae69273397d4c9f22626f|bd3f953d-891e-bb4e-0fdd-a81adf4a83eb", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-75": {
            ...
            animationType: "preset",
            eventTypeId: "MOUSE_CLICK",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-39", affectedElements: {}, playInReverse: false, autoStopEventId: "e-76" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae69273397d4c9f22626f|bd3f953d-891e-bb4e-0fdd-a81adf4a83f0", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae69273397d4c9f22626f|bd3f953d-891e-bb4e-0fdd-a81adf4a83f0", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1676342883568,
        },
        "e-76": {
            ...
            animationType: "preset",
            eventTypeId: "MOUSE_SECOND_CLICK",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-40", affectedElements: {}, playInReverse: false, autoStopEventId: "e-75" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae69273397d4c9f22626f|bd3f953d-891e-bb4e-0fdd-a81adf4a83f0", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae69273397d4c9f22626f|bd3f953d-891e-bb4e-0fdd-a81adf4a83f0", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-77": {
            ...
            animationType: "preset",
            eventTypeId: "MOUSE_CLICK",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-39", affectedElements: {}, playInReverse: false, autoStopEventId: "e-78" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae69273397d4c9f22626f|bd3f953d-891e-bb4e-0fdd-a81adf4a83f5", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae69273397d4c9f22626f|bd3f953d-891e-bb4e-0fdd-a81adf4a83f5", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1676342883568,
        },
        "e-78": {
            ...
            animationType: "preset",
            eventTypeId: "MOUSE_SECOND_CLICK",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-40", affectedElements: {}, playInReverse: false, autoStopEventId: "e-77" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae69273397d4c9f22626f|bd3f953d-891e-bb4e-0fdd-a81adf4a83f5", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae69273397d4c9f22626f|bd3f953d-891e-bb4e-0fdd-a81adf4a83f5", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-79": {
            ...
            animationType: "preset",
            eventTypeId: "MOUSE_CLICK",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-39", affectedElements: {}, playInReverse: false, autoStopEventId: "e-80" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae69273397d4c9f22626f|bd3f953d-891e-bb4e-0fdd-a81adf4a83fa", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae69273397d4c9f22626f|bd3f953d-891e-bb4e-0fdd-a81adf4a83fa", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1676342883568,
        },
        "e-80": {
            ...
            animationType: "preset",
            eventTypeId: "MOUSE_SECOND_CLICK",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-40", affectedElements: {}, playInReverse: false, autoStopEventId: "e-79" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae69273397d4c9f22626f|bd3f953d-891e-bb4e-0fdd-a81adf4a83fa", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae69273397d4c9f22626f|bd3f953d-891e-bb4e-0fdd-a81adf4a83fa", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-83": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-7", affectedElements: {}, playInReverse: false, autoStopEventId: "e-84" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dd7d5878a04717bd29ff9a|412a6160-8aa2-e7b7-0849-84448f6ab01a", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dd7d5878a04717bd29ff9a|412a6160-8aa2-e7b7-0849-84448f6ab01a", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1676475751439,
        },
        "e-84": {
            id: "e-84",
            name: "",
            animationType: "custom",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-8", affectedElements: {}, playInReverse: false, autoStopEventId: "e-83" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dd7d5878a04717bd29ff9a|412a6160-8aa2-e7b7-0849-84448f6ab01a", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dd7d5878a04717bd29ff9a|412a6160-8aa2-e7b7-0849-84448f6ab01a", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1676475751441,
        },
        "e-99": {
            id: "e-99",
            name: "",
            animationType: "preset",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-7", affectedElements: {}, playInReverse: false, autoStopEventId: "e-100" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae69273397d4c9f22626f|2dc850af-ab15-4bf2-d291-8884d1ae9ec5", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae69273397d4c9f22626f|2dc850af-ab15-4bf2-d291-8884d1ae9ec5", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-100": {
            ...
            animationType: "preset",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-8", affectedElements: {}, playInReverse: false, autoStopEventId: "e-99" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae69273397d4c9f22626f|2dc850af-ab15-4bf2-d291-8884d1ae9ec5", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae69273397d4c9f22626f|2dc850af-ab15-4bf2-d291-8884d1ae9ec5", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-105": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-54", affectedElements: {}, playInReverse: false, autoStopEventId: "e-106" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "156404c8-e490-2bf1-c617-e658209d75cd", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "156404c8-e490-2bf1-c617-e658209d75cd", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-107": {
            ...
            animationType: "preset",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-54", affectedElements: {}, playInReverse: false, autoStopEventId: "e-108" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".button_medium", originalId: "63dae69273397d4c9f22626f|30cac943-434f-4663-1969-53df579211ff", appliesTo: "CLASS" },
            targets: [{ selector: ".button_medium", originalId: "63dae69273397d4c9f22626f|30cac943-434f-4663-1969-53df579211ff", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-108": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-55", affectedElements: {}, playInReverse: false, autoStopEventId: "e-107" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".button_medium", originalId: "63dae69273397d4c9f22626f|30cac943-434f-4663-1969-53df579211ff", appliesTo: "CLASS" },
            targets: [{ selector: ".button_medium", originalId: "63dae69273397d4c9f22626f|30cac943-434f-4663-1969-53df579211ff", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-115": {
            ...
            animationType: "preset",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-56", affectedElements: {}, playInReverse: false, autoStopEventId: "e-116" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae69273397d4c9f22626f|0d0fd482-449f-be2a-ea34-30fb497a659d", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae69273397d4c9f22626f|0d0fd482-449f-be2a-ea34-30fb497a659d", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-116": {
            ...
            animationType: "preset",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-57", affectedElements: {}, playInReverse: false, autoStopEventId: "e-115" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dae69273397d4c9f22626f|0d0fd482-449f-be2a-ea34-30fb497a659d", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dae69273397d4c9f22626f|0d0fd482-449f-be2a-ea34-30fb497a659d", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-117": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-9", affectedElements: {}, playInReverse: false, autoStopEventId: "e-118" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "21a171ba-87cf-c337-da53-1aa71201346e", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "21a171ba-87cf-c337-da53-1aa71201346e", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-118": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-10", affectedElements: {}, playInReverse: false, autoStopEventId: "e-117" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "21a171ba-87cf-c337-da53-1aa71201346e", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "21a171ba-87cf-c337-da53-1aa71201346e", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-121": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-62", affectedElements: {}, playInReverse: false, autoStopEventId: "e-122" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "8bec40d9-794e-f9c7-fdb7-6252708a3488", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "8bec40d9-794e-f9c7-fdb7-6252708a3488", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-122": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-63", affectedElements: {}, playInReverse: false, autoStopEventId: "e-121" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "8bec40d9-794e-f9c7-fdb7-6252708a3488", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "8bec40d9-794e-f9c7-fdb7-6252708a3488", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-125": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_CLICK",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-39", affectedElements: {}, playInReverse: false, autoStopEventId: "e-126" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".checkbox_trigger", originalId: "63dd7d5878a04717bd29ff9a|9297965a-f8f3-4384-62e2-374020b29427", appliesTo: "CLASS" },
            targets: [{ selector: ".checkbox_trigger", originalId: "63dd7d5878a04717bd29ff9a|9297965a-f8f3-4384-62e2-374020b29427", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-126": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_SECOND_CLICK",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-40", affectedElements: {}, playInReverse: false, autoStopEventId: "e-125" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".checkbox_trigger", originalId: "63dd7d5878a04717bd29ff9a|9297965a-f8f3-4384-62e2-374020b29427", appliesTo: "CLASS" },
            targets: [{ selector: ".checkbox_trigger", originalId: "63dd7d5878a04717bd29ff9a|9297965a-f8f3-4384-62e2-374020b29427", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-128": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63f39261e65caf960d5fe302|7b162bf9-a9e9-3bb0-c1e1-8eae3a5ca4dc", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63f39261e65caf960d5fe302|7b162bf9-a9e9-3bb0-c1e1-8eae3a5ca4dc", appliesTo: "ELEMENT", styleBlockIds: [] }],
        ...
        "e-129": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-67", affectedElements: {}, playInReverse: false, autoStopEventId: "e-130" } },
            mediaQueries: ["main"],
            target: { selector: ".cs_projects-link", originalId: "63f39261e65caf960d5fe302|28090dd5-bf1f-3b30-16e8-3e0e90170a21", appliesTo: "CLASS" },
            targets: [{ selector: ".cs_projects-link", originalId: "63f39261e65caf960d5fe302|28090dd5-bf1f-3b30-16e8-3e0e90170a21", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-130": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-68", affectedElements: {}, playInReverse: false, autoStopEventId: "e-129" } },
            mediaQueries: ["main"],
            target: { selector: ".cs_projects-link", originalId: "63f39261e65caf960d5fe302|28090dd5-bf1f-3b30-16e8-3e0e90170a21", appliesTo: "CLASS" },
            targets: [{ selector: ".cs_projects-link", originalId: "63f39261e65caf960d5fe302|28090dd5-bf1f-3b30-16e8-3e0e90170a21", appliesTo: "CLASS" }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-133": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OVER",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-72", affectedElements: {}, playInReverse: false, autoStopEventId: "e-134" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dd31e523449e896011cded|b4068d7f-474e-108a-7d8c-4d2c94b87412", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dd31e523449e896011cded|b4068d7f-474e-108a-7d8c-4d2c94b87412", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
        ...
        "e-134": {
            ...
            animationType: "custom",
            eventTypeId: "MOUSE_OUT",
            action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-73", affectedElements: {}, playInReverse: false, autoStopEventId: "e-133" } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { id: "63dd31e523449e896011cded|b4068d7f-474e-108a-7d8c-4d2c94b87412", appliesTo: "ELEMENT", styleBlockIds: [] },
            targets: [{ id: "63dd31e523449e896011cded|b4068d7f-474e-108a-7d8c-4d2c94b87412", appliesTo: "ELEMENT", styleBlockIds: [] }],
            config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
    ...
    actionLists: {
                    ...
                    actionItems: [
                        {
                            ...
                            config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".primary_panel-1", selectorGuids: ["ea75bbd9-0752-f1c8-8196-8e3841233cc5"] }, value: 1, unit: "" },
                        },
                        {
                            id: "a-n-2",
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".primary_fill", selectorGuids: ["e9106d5f-f68c-40e5-9b23-95b9cc667c29"] },
                                yValue: 0,
                                xUnit: "PX",
                                yUnit: "%",
                                zUnit: "PX",
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".primary_panel-2", selectorGuids: ["b1137cf6-16dc-3fd5-057f-4521b8f034dd"] },
                                yValue: 100,
                                xUnit: "PX",
                                yUnit: "%",
                                zUnit: "PX",
                    ...
                    actionItems: [
                        {
                            id: "a-n-4",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "outCubic", duration: 200, target: { useEventTarget: "CHILDREN", selector: ".primary_panel-1", selectorGuids: ["ea75bbd9-0752-f1c8-8196-8e3841233cc5"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-n-5",
                            actionTypeId: "TRANSFORM_MOVE",
                    ...
                    actionItems: [
                        {
                            id: "a-2-n-4",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "outCubic", duration: 200, target: { useEventTarget: "CHILDREN", selector: ".primary_panel-1", selectorGuids: ["ea75bbd9-0752-f1c8-8196-8e3841233cc5"] }, value: 1, unit: "" },
                        },
                        {
                            id: "a-2-n-5",
                            actionTypeId: "TRANSFORM_MOVE",
                    ...
                    actionItems: [
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".html-embed", selectorGuids: ["15b5dd70-4e87-7b63-cbec-cadf84828771"] },
                                xValue: -100,
                                xUnit: "%",
                                yUnit: "PX",
                                zUnit: "PX",
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".nav-top_melonhead", selectorGuids: ["28cec278-4292-389a-3146-1b8152091f50"] },
                                yValue: 75,
                                xUnit: "PX",
                                yUnit: "%",
                                zUnit: "PX",
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".expand", selectorGuids: ["41a30a19-b0cf-6403-9681-fc03d41ef4bd"] },
                                        widthValue: 90,
                                        heightValue: 82,
                                        widthUnit: "vw",
                                        heightUnit: "vh",
                    ...
                    actionItems: [
                        {
                            id: "a-15-n",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", id: "63dae19244d4326cd3f5baa5|d6405171-e1d1-4a40-fcbf-e86775599a99" }, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                        },
                        {
                            id: "a-15-n-2",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", id: "63dae19244d4326cd3f5baa5|d50d46ff-f48b-197f-579e-43775b27d5cf" }, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                        },
                        {
                            id: "a-15-n-3",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", id: "63dae19244d4326cd3f5baa5|69797d02-12b4-5517-c52c-174d95c27057" }, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                        },
                    ],
                },
                {
                    actionItems: [
                        {
                            id: "a-15-n-4",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: { delay: 0, easing: "ease", duration: 300, target: { useEventTarget: "CHILDREN", id: "63dae19244d4326cd3f5baa5|d6405171-e1d1-4a40-fcbf-e86775599a99" }, yValue: -75, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                        },
                        {
                            id: "a-15-n-5",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "ease",
                                duration: 300,
                                target: { useEventTarget: "CHILDREN", id: "63dae19244d4326cd3f5baa5|d50d46ff-f48b-197f-579e-43775b27d5cf" },
                                yValue: -75,
                                xUnit: "PX",
                                yUnit: "%",
                                zUnit: "PX",
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                easing: "ease",
                                duration: 300,
                                target: { useEventTarget: "CHILDREN", id: "63dae19244d4326cd3f5baa5|69797d02-12b4-5517-c52c-174d95c27057" },
                                yValue: -75,
                                xUnit: "PX",
                                yUnit: "%",
                                zUnit: "PX",
                    ...
                    actionItems: [
                        {
                            id: "a-15-n-7",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: { delay: 0, easing: "ease", duration: 300, target: { useEventTarget: "CHILDREN", id: "63dae19244d4326cd3f5baa5|d6405171-e1d1-4a40-fcbf-e86775599a99" }, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                        },
                        {
                            id: "a-15-n-8",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: { delay: 100, easing: "ease", duration: 300, target: { useEventTarget: "CHILDREN", id: "63dae19244d4326cd3f5baa5|d50d46ff-f48b-197f-579e-43775b27d5cf" }, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                        },
                        {
                            id: "a-15-n-9",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: { delay: 200, easing: "ease", duration: 300, target: { useEventTarget: "CHILDREN", id: "63dae19244d4326cd3f5baa5|69797d02-12b4-5517-c52c-174d95c27057" }, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                        },
                    ],
                },
            ],
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".logo-column.normal", selectorGuids: ["d002f835-529a-61ff-e1a8-2e1d9d4cffb7", "28d4704a-90b1-6ea3-5d85-8372fcf00fa0"] },
                                        yValue: 10,
                                        xUnit: "PX",
                                        yUnit: "%",
                                        zUnit: "PX",
                                ...
                                },
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".logo-column.reversed", selectorGuids: ["d002f835-529a-61ff-e1a8-2e1d9d4cffb7", "d9ef3a4a-588f-f5de-edbb-f2f2177999b4"] },
                                        yValue: -10,
                                        xUnit: "PX",
                                        yUnit: "%",
                                        zUnit: "PX",
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: true, id: "63dae19244d4326cd3f5baa5|0de71448-2f69-9395-3a7b-c5305a070ce6" },
                                widthValue: 100,
                                widthUnit: "%",
                                heightUnit: "PX",
                                locked: false,
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".home_hero-vid", selectorGuids: ["438f9df9-3580-fa9e-c523-441a757ba98a"] },
                                globalSwatchId: "",
                                rValue: 5,
                                bValue: 15,
                                gValue: 7,
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".home_hero-play", selectorGuids: ["8ec8fcae-cd09-6b74-a4ec-a16f4b822725"] },
                                globalSwatchId: "",
                                rValue: 255,
                                bValue: 255,
                                gValue: 255,
        ...
        "a-22": {
            ...
            actionItemGroups: [
                {
                    actionItems: [
                        { id: "a-22-n", actionTypeId: "GENERAL_DISPLAY", config: { delay: 0, easing: "", duration: 0, target: { id: "63dae19244d4326cd3f5baa5|19951594-5c4a-dae5-3e84-d4c7208ef86f" }, value: "none" } },
                        { id: "a-22-n-2", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: { id: "63dae19244d4326cd3f5baa5|19951594-5c4a-dae5-3e84-d4c7208ef86f" }, value: 0, unit: "" } },
                    ],
                },
                { actionItems: [{ id: "a-22-n-3", actionTypeId: "GENERAL_DISPLAY", config: { delay: 0, easing: "", duration: 0, target: { id: "63dae19244d4326cd3f5baa5|19951594-5c4a-dae5-3e84-d4c7208ef86f" }, value: "block" } }] },
                { actionItems: [{ id: "a-22-n-4", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "ease", duration: 300, target: { id: "63dae19244d4326cd3f5baa5|19951594-5c4a-dae5-3e84-d4c7208ef86f" }, value: 1, unit: "" } }] },
            ],
            useFirstGroupAsInitialState: true,
        ...
        "a-23": {
            ...
            title: "hide video",
            actionItemGroups: [
                { actionItems: [{ id: "a-23-n-4", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "ease", duration: 200, target: { id: "63dae19244d4326cd3f5baa5|19951594-5c4a-dae5-3e84-d4c7208ef86f" }, value: 0, unit: "" } }] },
                { actionItems: [{ id: "a-23-n-3", actionTypeId: "GENERAL_DISPLAY", config: { delay: 0, easing: "", duration: 0, target: { id: "63dae19244d4326cd3f5baa5|19951594-5c4a-dae5-3e84-d4c7208ef86f" }, value: "none" } }] },
            ],
            useFirstGroupAsInitialState: false,
            createdOn: 1675824363956,
        },
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".icon-88", selectorGuids: ["4b9395e6-ac15-05eb-d7d7-9159776fd6d2"] },
                                zValue: 0,
                                xUnit: "DEG",
                                yUnit: "DEG",
                                zUnit: "deg",
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: true, id: "63dae19244d4326cd3f5baa5|4fd00fb7-e1ef-2976-df50-fe07471bb794" },
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".footer_contact-expand", selectorGuids: ["7333a6a8-b3f3-2b67-4f00-c27d10be94fe"] },
                                xValue: 1,
                                yValue: 1,
                                locked: true,
                            },
                        ...
                        },
                        {
                            ...
                            config: { delay: 0, easing: "", duration: 0, target: { useEventTarget: "CHILDREN", selector: ".footer_contact-circle", selectorGuids: ["ae16d9a6-f21d-20c7-1bbc-6efaf8d3053a"] }, value: "flex" },
                        },
                        {
                            id: "a-30-n-10",
                            actionTypeId: "GENERAL_DISPLAY",
                            config: { delay: 0, easing: "", duration: 0, target: { useEventTarget: "CHILDREN", selector: ".footer_contact-coffee", selectorGuids: ["7523b8fe-4209-aa59-f72f-41c3f3450519"] }, value: "none" },
                        },
                        {
                            id: "a-30-n-11",
                            actionTypeId: "TRANSFORM_SCALE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".footer_contact-coffee", selectorGuids: ["7523b8fe-4209-aa59-f72f-41c3f3450519"] },
                                xValue: 0.8,
                                yValue: 0.8,
                                locked: true,
                            },
                    ...
                    actionItems: [
                        {
                            id: "a-30-n-12",
                            actionTypeId: "GENERAL_DISPLAY",
                            config: { delay: 0, easing: "", duration: 0, target: { useEventTarget: "CHILDREN", selector: ".footer_contact-coffee", selectorGuids: ["7523b8fe-4209-aa59-f72f-41c3f3450519"] }, value: "block" },
                        },
                        {
                            id: "a-30-n-9",
                            actionTypeId: "GENERAL_DISPLAY",
                            config: { delay: 0, easing: "", duration: 0, target: { useEventTarget: "CHILDREN", selector: ".footer_contact-circle", selectorGuids: ["ae16d9a6-f21d-20c7-1bbc-6efaf8d3053a"] }, value: "none" },
                        },
                    ],
                },
                {
                    actionItems: [
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 0,
                                target: { useEventTarget: "CHILDREN", selector: ".footer_contact-circle", selectorGuids: ["ae16d9a6-f21d-20c7-1bbc-6efaf8d3053a"] },
                                xValue: 0.8,
                                yValue: 0.8,
                                locked: true,
                            },
                    ...
                    actionItems: [
                        {
                            id: "a-34-n-2",
                            actionTypeId: "STYLE_TEXT_COLOR",
                            config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "2744a9d0-5ca6-e329-6d5e-2d1778778de5" }, globalSwatchId: "dd05ad2b", rValue: 255, bValue: 255, gValue: 255, aValue: 1 },
                        },
                        {
                            id: "a-34-n-3",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".arrow-static", selectorGuids: ["96ade7a4-250b-37ab-4f1a-04fa1055c4bc"] },
                                xValue: 0,
                                xUnit: "%",
                                yUnit: "PX",
                                zUnit: "PX",
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".arrow-absolute", selectorGuids: ["cf509f44-1b77-70c9-216e-bb506e4fb568"] },
                                xValue: -100,
                                xUnit: "%",
                                yUnit: "PX",
                                zUnit: "PX",
                    ...
                    actionItems: [
                        {
                            id: "a-34-n-5",
                            actionTypeId: "STYLE_TEXT_COLOR",
                            config: { delay: 0, easing: "ease", duration: 300, target: { useEventTarget: true, id: "2744a9d0-5ca6-e329-6d5e-2d1778778de5" }, globalSwatchId: "0ead2d9d", rValue: 246, bValue: 94, gValue: 250, aValue: 1 },
                        },
                        {
                            id: "a-34-n-7",
                            actionTypeId: "TRANSFORM_MOVE",
                    ...
                    actionItems: [
                        {
                            id: "a-35-n-4",
                            actionTypeId: "STYLE_TEXT_COLOR",
                            config: { delay: 0, easing: "ease", duration: 300, target: { useEventTarget: true, id: "2744a9d0-5ca6-e329-6d5e-2d1778778de5" }, globalSwatchId: "dd05ad2b", rValue: 255, bValue: 255, gValue: 255, aValue: 1 },
                        },
                        {
                            id: "a-35-n-5",
                            actionTypeId: "TRANSFORM_MOVE",
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".card-container.wonder-dynamics", selectorGuids: ["5f330c88-42d9-f30d-c6e6-369d006db1d4", "2553a279-1a46-bd4e-51df-fb7ad9cd4fef"] },
                                        xValue: 22,
                                        yValue: 23,
                                        xUnit: "em",
                                        yUnit: "em",
                                ...
                                },
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".card-container.scott", selectorGuids: ["5f330c88-42d9-f30d-c6e6-369d006db1d4", "27cb93c3-707d-3b79-3ae0-43b0c7f9d05e"] },
                                        xValue: 3,
                                        yValue: 22,
                                        xUnit: "em",
                                        yUnit: "em",
                                ...
                                },
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".card-container.merck", selectorGuids: ["5f330c88-42d9-f30d-c6e6-369d006db1d4", "06d08d13-7c38-63e0-f966-e6932db9fa0c"] },
                                        xValue: -21,
                                        yValue: 22,
                                        xUnit: "em",
                                        yUnit: "em",
                                ...
                                },
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".card-container.pencil", selectorGuids: ["5f330c88-42d9-f30d-c6e6-369d006db1d4", "89670b03-2271-fdaf-6dd2-f854d1cd70ac"] },
                                        xValue: -33,
                                        yValue: 8,
                                        xUnit: "em",
                                        yUnit: "em",
                                ...
                                },
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".card-container.solana", selectorGuids: ["5f330c88-42d9-f30d-c6e6-369d006db1d4", "cbb665df-f018-5eae-280f-f27b4820580f"] },
                                        xValue: -30,
                                        yValue: -8,
                                        xUnit: "em",
                                        yUnit: "em",
                                ...
                                },
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".card-container.farley", selectorGuids: ["5f330c88-42d9-f30d-c6e6-369d006db1d4", "74cf4476-a5e4-7fc8-ebbf-dccd4bb65bc1"] },
                                        xValue: -23,
                                        yValue: -25,
                                        xUnit: "em",
                                        yUnit: "em",
                                ...
                                },
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".card-container.safepal", selectorGuids: ["5f330c88-42d9-f30d-c6e6-369d006db1d4", "fa307d5b-073d-a994-b8a6-40f39c1b21e7"] },
                                        xValue: -5,
                                        yValue: -27,
                                        xUnit: "em",
                                        yUnit: "em",
                                ...
                                },
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".card-container.shaq", selectorGuids: ["5f330c88-42d9-f30d-c6e6-369d006db1d4", "5827960c-0b05-fb8b-88ff-7c171ecdcbd4"] },
                                        xValue: -11,
                                        yValue: -16,
                                        xUnit: "em",
                                        yUnit: "em",
                                ...
                                },
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".card-container.chat", selectorGuids: ["5f330c88-42d9-f30d-c6e6-369d006db1d4", "e1239400-6325-98fc-52fe-7ebc2c8a755a"] },
                                        xValue: 23,
                                        yValue: -27,
                                        xUnit: "em",
                                        yUnit: "em",
                                ...
                                },
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".card-container.cocoon", selectorGuids: ["5f330c88-42d9-f30d-c6e6-369d006db1d4", "e582be0d-362f-e5f8-f0e2-d9ac43a8c756"] },
                                        xValue: 25,
                                        yValue: -14,
                                        xUnit: "em",
                                        yUnit: "em",
                                ...
                                },
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".card-container.clutch", selectorGuids: ["5f330c88-42d9-f30d-c6e6-369d006db1d4", "3d436a47-0479-6ae6-673c-b6b2b11a39e7"] },
                                        xValue: 19,
                                        yValue: 9,
                                        xUnit: "em",
                                        yUnit: "em",
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".icon-24", selectorGuids: ["1204f33d-fd2b-cdcf-65e6-e84ef53da349"] },
                                        zValue: 0,
                                        xUnit: "DEG",
                                        yUnit: "DEG",
                                        zUnit: "deg",
                                ...
                                },
                                {
                                    ...
                                    config: {
                                        ...
                                        easing: "",
                                        duration: 500,
                                        target: { useEventTarget: "CHILDREN", selector: ".squiggle_embed", selectorGuids: ["70e22066-b254-85d0-d4f3-d6f251d4834a"] },
                                        xValue: 0,
                                        xUnit: "%",
                                        yUnit: "PX",
                                        zUnit: "PX",
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "ease",
                                duration: 300,
                                target: { useEventTarget: "PARENT", selector: ".radio-pill", selectorGuids: ["6510a2b7-580d-5291-fb25-6fb040a6ce4c"] },
                                globalSwatchId: "dd05ad2b",
                                rValue: 255,
                                bValue: 255,
                                gValue: 255,
                        ...
                        { id: "a-41-n-3", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 300, target: {}, yValue: -100, xUnit: "PX", yUnit: "%", zUnit: "PX" } },
                    ],
                },
            ],
            useFirstGroupAsInitialState: false,
        ...
        "a-42": {
            ...
            actionItemGroups: [
                {
                    actionItems: [
                        { id: "a-42-n", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 300, target: {}, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" } },
                        {
                            id: "a-42-n-2",
                            actionTypeId: "STYLE_TEXT_COLOR",
                            config: {
                                ...
                                easing: "ease",
                                duration: 200,
                                target: { selector: ".radio-pill", selectorGuids: ["6510a2b7-580d-5291-fb25-6fb040a6ce4c"] },
                ...
                {
                    actionItems: [
                        { id: "a-42-n-3", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 300, target: {}, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" } },
                        {
                            id: "a-42-n-4",
                            actionTypeId: "STYLE_TEXT_COLOR",
                            config: {
                    ...
                    actionItems: [
                        {
                            id: "a-43-n-11",
                            actionTypeId: "STYLE_TEXT_COLOR",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".radio", selectorGuids: ["68633be7-8e54-85fe-a32b-b648395c4529"] }, globalSwatchId: "09b8bce2", rValue: 5, bValue: 15, gValue: 7, aValue: 1 },
                        },
                        {
                            id: "a-43-n-13",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".radio_fill", selectorGuids: ["68633be7-8e54-85fe-a32b-b648395c452e"] }, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                        },
                    ],
                },
                {
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "ease",
                                duration: 200,
                                target: { selector: ".radio", selectorGuids: ["68633be7-8e54-85fe-a32b-b648395c4529"] },
                                globalSwatchId: "09b8bce2",
                                rValue: 5,
                                bValue: 15,
                                gValue: 7,
                        ...
                        },
                        {
                            id: "a-43-n-14",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: { delay: 0, easing: "ease", duration: 200, target: { selector: ".radio_fill", selectorGuids: ["68633be7-8e54-85fe-a32b-b648395c452e"] }, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                        },
                    ],
                },
            ],
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "ease",
                                duration: 300,
                                target: { useEventTarget: "PARENT", selector: ".radio", selectorGuids: ["68633be7-8e54-85fe-a32b-b648395c4529"] },
                                globalSwatchId: "dd05ad2b",
                                rValue: 255,
                                bValue: 255,
                                gValue: 255,
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                easing: "ease",
                                duration: 300,
                                target: { useEventTarget: "CHILDREN", selector: ".radio_fill", selectorGuids: ["68633be7-8e54-85fe-a32b-b648395c452e"] },
                                yValue: -100,
                                xUnit: "PX",
                                yUnit: "%",
                                zUnit: "PX",
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "SIBLINGS", selector: ".checkbox_fill", selectorGuids: ["bd80dd1e-e08d-b5ff-abb4-f4038173a7e5"] },
                                yValue: 100,
                                xUnit: "PX",
                                yUnit: "%",
                                zUnit: "PX",
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "PARENT", selector: ".checkbox", selectorGuids: ["65d28396-18d8-86cf-2401-3399b69f893b"] },
                                globalSwatchId: "09b8bce2",
                                rValue: 5,
                                bValue: 15,
                                gValue: 7,
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".button_medium-arrow.start", selectorGuids: ["8c2c2f04-6514-e1d0-8dff-1cb258ba5329", "c7493980-1e39-21bd-cebb-36b4f90da62e"] },
                                xValue: 0,
                                xUnit: "%",
                                yUnit: "PX",
                                zUnit: "PX",
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".button_medium-arrow.finish", selectorGuids: ["8c2c2f04-6514-e1d0-8dff-1cb258ba5329", "841f471d-19c1-084a-fd2b-33b6bce43e85"] },
                                xValue: -100,
                                xUnit: "%",
                                yUnit: "PX",
                                zUnit: "PX",
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".connect_yellow", selectorGuids: ["ad49ca0e-69d5-8ff4-4e11-f6d1182b9ca9"] },
                                yValue: 0,
                                xUnit: "PX",
                                yUnit: "%",
                                zUnit: "PX",
                        ...
                        },
                        {
                            id: "a-56-n-2",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".connect_yellow-panel", selectorGuids: ["a64e8ce6-695e-b344-1919-774793de1b0c"] }, value: 1, unit: "" },
                        },
                        {
                            id: "a-56-n-3",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".connect_green-panel", selectorGuids: ["635115ff-4261-8e5b-19d9-b4d399b2d042"] },
                                yValue: 100,
                                xUnit: "PX",
                                yUnit: "%",
                                zUnit: "PX",
                ...
                },
                {
                    actionItems: [
                        ...
                        },
                        {
                            id: "a-56-n-5",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "outCubic", duration: 200, target: { useEventTarget: "CHILDREN", selector: ".connect_yellow-panel", selectorGuids: ["a64e8ce6-695e-b344-1919-774793de1b0c"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-56-n-6",
                            actionTypeId: "TRANSFORM_MOVE",
            ...
            actionItemGroups: [
                {
                    actionItems: [
                        ...
                        },
                        {
                            id: "a-57-n-2",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "outCubic", duration: 100, target: { useEventTarget: "CHILDREN", selector: ".connect_yellow-panel", selectorGuids: ["a64e8ce6-695e-b344-1919-774793de1b0c"] }, value: 1, unit: "" },
                        },
                    ],
                },
                {
                ...
                },
                {
                    actionItems: [
                        ...
                        },
                        {
                            id: "a-9-n-5",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "outQuart", duration: 200, target: { useEventTarget: "CHILDREN", selector: ".connect_yellow-panel", selectorGuids: ["a64e8ce6-695e-b344-1919-774793de1b0c"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-9-n-6",
                            actionTypeId: "TRANSFORM_MOVE",
            ...
            actionItemGroups: [
                {
                    actionItems: [
                        ...
                        },
                        {
                            id: "a-10-n-5",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "outQuart", duration: 100, target: { useEventTarget: "CHILDREN", selector: ".connect_yellow-panel", selectorGuids: ["a64e8ce6-695e-b344-1919-774793de1b0c"] }, value: 1, unit: "" },
                        },
                    ],
                },
                {
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".button_large-arrow", selectorGuids: ["69242660-d87d-8d8e-018c-cf126e40b7ea"] },
                                xValue: -100,
                                xUnit: "%",
                                yUnit: "PX",
                                zUnit: "PX",
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", selector: ".button_text-wrap", selectorGuids: ["33ea38f6-b092-0451-ce49-197d036ed6ff"] },
                                xValue: 0,
                                xUnit: "em",
                                yUnit: "PX",
                                zUnit: "PX",
                            ...
                            actionItems: [
                                {
                                    id: "a-66-n",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "63f39261e65caf960d5fe302|93dad9ae-f9cc-08e0-2931-0f8dccb2166d" }, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                                },
                                { id: "a-66-n-2", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: { id: "63f39261e65caf960d5fe302|93dad9ae-f9cc-08e0-2931-0f8dccb2166d" }, value: 1, unit: "" } },
                            ],
                        },
                        {
                            keyframe: 75,
                            actionItems: [
                                {
                                    id: "a-66-n-3",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { id: "63f39261e65caf960d5fe302|93dad9ae-f9cc-08e0-2931-0f8dccb2166d" }, yValue: 100, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                                },
                                { id: "a-66-n-4", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: { id: "63f39261e65caf960d5fe302|93dad9ae-f9cc-08e0-2931-0f8dccb2166d" }, value: 0, unit: "" } },
                            ],
                        },
                    ],
                },
                    ...
                    actionItems: [
                        {
                            id: "a-67-n",
                            actionTypeId: "TRANSFORM_SCALE",
                            config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".image-cover", selectorGuids: ["82ff736e-1ba0-eda5-21f6-6ba1c83ad214"] }, xValue: 1, yValue: 1, locked: true },
                        },
                    ],
                },
                {
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "ease",
                                duration: 300,
                                target: { useEventTarget: "CHILDREN", selector: ".image-cover", selectorGuids: ["82ff736e-1ba0-eda5-21f6-6ba1c83ad214"] },
                                xValue: 1.1,
                                yValue: 1.1,
                                locked: true,
                            },
                    ...
                    actionItems: [
                        {
                            id: "a-68-n-2",
                            actionTypeId: "TRANSFORM_SCALE",
                            config: { delay: 0, easing: "ease", duration: 200, target: { useEventTarget: "CHILDREN", selector: ".image-cover", selectorGuids: ["82ff736e-1ba0-eda5-21f6-6ba1c83ad214"] }, xValue: 1, yValue: 1, locked: true },
                        },
                    ],
                },
            ],
                    ...
                    actionItems: [
                        {
                            id: "a-72-n",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "ease", duration: 250, target: { useEventTarget: true, id: "63dd31e523449e896011cded|b4068d7f-474e-108a-7d8c-4d2c94b87412" }, value: 0, unit: "" },
                        },
                        {
                            id: "a-72-n-3",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "ease",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", boundaryMode: true, id: "63f39261e65caf960d5fe302|9afc4ac8-dd8c-f81f-e66c-f9d29e50809a" },
                                yValue: 40,
                                xUnit: "PX",
                                yUnit: "px",
                                zUnit: "PX",
                    ...
                    actionItems: [
                        {
                            id: "a-72-n-2",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "ease", duration: 250, target: { useEventTarget: true, id: "63dd31e523449e896011cded|b4068d7f-474e-108a-7d8c-4d2c94b87412" }, value: 1, unit: "" },
                        },
                        {
                            id: "a-72-n-4",
                            actionTypeId: "TRANSFORM_MOVE",
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                easing: "ease",
                                duration: 500,
                                target: { useEventTarget: "CHILDREN", boundaryMode: true, id: "63dd31e523449e896011cded|51c225df-2b63-47b2-af7f-8e90acff0d3b" },
                                yValue: -40,
                                xUnit: "PX",
                                yUnit: "px",
                                zUnit: "PX",
                        ...
                        },
                        {
                            id: "a-73-n",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "ease", duration: 500, target: { useEventTarget: true, id: "63dd31e523449e896011cded|b4068d7f-474e-108a-7d8c-4d2c94b87412" }, value: 0, unit: "" },
                        },
                    ],
                },
                {
